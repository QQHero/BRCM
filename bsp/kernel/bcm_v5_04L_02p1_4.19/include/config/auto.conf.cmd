deps_config := \
	...
	drivers/Kconfig \
	net/tenda/wifi/Kconfig \
	net/tenda/bsp/Kconfig \
	net/tenda/km/Kconfig \
	net/tenda/Kconfig \
	net/ife/Kconfig \
	net/psample/Kconfig \
...
ifneq "$(KERNELVERSION)" "4.19.183"
include/config/auto.conf: FORCE
endif
ifneq "$(CC_VERSION_TEXT)" "arm-buildroot-linux-gnueabi-gcc.br_real (Buildroot 2019.11.1) 9.2.0"
include/config/auto.conf: FORCE
endif
ifneq "$(srctree)" "."
include/config/auto.conf: FORCE
endif
ifneq "$(CC)" "/projects/hnd/tools/bcm/crosstools-arm-gcc-9.2-linux-4.19-glibc-2.30-binutils-2.32/usr/bin/arm-buildroot-linux-gnueabi-gcc"
include/config/auto.conf: FORCE
endif
ifneq "$(LD)" "/projects/hnd/tools/bcm/crosstools-arm-gcc-9.2-linux-4.19-glibc-2.30-binutils-2.32/usr/bin/arm-buildroot-linux-gnueabi-ld"
include/config/auto.conf: FORCE
endif
ifneq "$(SRCARCH)" "arm"
include/config/auto.conf: FORCE
